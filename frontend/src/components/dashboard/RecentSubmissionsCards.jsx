...
const RecentSubmissionsCards = () => {
  ...
  const categoryColor = categoryColors[submission.category] || 'bg-gray-100 text-gray-700';
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <Link to={`/submissions/${submission._id}`} className="block group">
        <div className="bg-white rounded-xl border border-gray-200/60 shadow-sm p-6 hover:shadow-md hover:border-gray-300/80 transition-all duration-200">
